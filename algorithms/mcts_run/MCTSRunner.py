...
def parse_args():
    ...
    base_args.add_argument('--input_file', type=str, default='/clean_prm_sftData.json')
    base_args.add_argument('--task_name', type=str, default='math')
    base_args.add_argument('--file', type=str, default='math_500')  # json
    base_args.add_argument('--output_file', type=str, default='test')  # json
    base_args.add_argument('--openai_api_key', type=str, default='EMPTY')  # json
    base_args.add_argument('--openai_api_base', type=str, default='http://localhost:8002/v1')  # json
