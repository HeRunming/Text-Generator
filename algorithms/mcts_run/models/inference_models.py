...
Format your answer as a **single float between 0 and 1**.
"""
def get_local_value_api(query, tokenizer=None, max_length=2048, truncation=True, max_new_tokens=2048, temperature=0.7, do_sample=False, pipe=None, processor=None, client=None, low=0, high=1):
    cnt = 2
    all_response = ''
